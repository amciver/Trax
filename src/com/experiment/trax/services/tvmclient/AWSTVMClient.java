 ...
 */
public class AWSTVMClient {
    private static final String LOG_TAG = "AWSTVMClient";
    ...
    public AWSTVMClient(SharedPreferences sharedPreferences, String endpoint, boolean useSSL) {
    ...
    public Response anonymousRegister() {
        ...
        if (AWSSharedPreferencesWrapper.getUidForDevice(this.sharedPreferences) == null) {
            ...
            if (response.requestWasSuccessful()) {
                AWSSharedPreferencesWrapper.registerDeviceId(this.sharedPreferences, uid, key);
            }
        }
    ...
    public Response getToken() {
        String uid = AWSSharedPreferencesWrapper.getUidForDevice(this.sharedPreferences);
        String key = AWSSharedPreferencesWrapper.getKeyForDevice(this.sharedPreferences);
        ...
        if (getTokenResponse.requestWasSuccessful()) {
            AWSSharedPreferencesWrapper.storeCredentialsInSharedPreferences(this.sharedPreferences, getTokenResponse.getAccessKey(), getTokenResponse.getSecretKey(), getTokenResponse.getSecurityToken(), getTokenResponse.getExpirationDate());
        }
